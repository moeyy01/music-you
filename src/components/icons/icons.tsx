...
function VolumeMediumIcon(props: SvgIconProps) {
  return <SvgIcon {...props}>
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
      <path fill="currentColor" d="M5 9v6h4l5 5V4L9 9m9.5 3c0-1.77-1-3.29-2.5-4.03V16c1.5-.71 2.5-2.24 2.5-4Z"/>
    </svg>
  </SvgIcon>
}
...
function StopWatchIcon(props: SvgIconProps) {
  return <SvgIcon {...props}>
